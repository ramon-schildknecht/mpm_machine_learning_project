...
# KNN
training.data.predictors <- cbind(training.data$int_rate,training.data$loan_amnt, training.data$revol_bal, training.data$revol_util)
test.data.predictors <- cbind(test.data$int_rate,test.data$loan_amnt, test.data$revol_bal, test.data$revol_util)
...
predict(glm.fit, newdata = test.data, type = "response")
...
tree.fit
predict(tree.fit,newdata = test.data, type = "response")
